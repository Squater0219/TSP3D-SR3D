TORCH_DISTRIBUTED_DEBUG=INFO CUDA_VISIBLE_DEVICES=6 python -m torch.distributed.launch \
    ...
    --detect_intermediate \
    --log_dir /data1/bone/mjgong/datasets/TSP3D_DATA/output/logs/test \
    --lr_decay_epochs 50 75 \
    --augment_det \
    --checkpoint_path /data1/bone/mjgong/research/backups/TSP3D_vanilla/TSP3D_2/pretrained_models/ckpt_scanrefer.pth \
    --eval